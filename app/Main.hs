...
import Clam (projectName, prettyFish, renderFish)
import FishAST
...
main = do
  ...
  putTextLn "Pretty-printing example AST:"
  putTextLn (renderFish exampleAST)
  putTextLn "\nDone!"